...
import {Card, Divider, FAB, Appbar} from 'react-native-paper';
  ...
  return (
    <>
      <Appbar.Header
        ...
        <Appbar.Content title="To Approve" titleStyle={{color: 'white'}} />
