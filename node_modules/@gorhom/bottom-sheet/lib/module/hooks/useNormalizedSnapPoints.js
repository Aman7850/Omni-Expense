...
export const useNormalizedSnapPoints = (snapPoints, containerHeight = 0, handleHeight = 0) => useMemo(() => {
  const normalizedSnapPoints = normalizeSnapPoints(snapPoints, containerHeight);
